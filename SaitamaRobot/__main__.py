...
🎛 *Reach out for support:* @PainRobotSupport [.](https://telegra.ph/file/2291942331f135e3292ee.png)
""".format(
    dispatcher.bot.first_name, ""
    if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\n")

KURISU_IMG = "https://telegra.ph/file/9127957b0437ed3a64332.jpg"
KURISUIMGSTART = "https://telegra.ph/file/9127957b0437ed3a64332.jpg"
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am now Reincarnated!](https://telegra.ph/file/b5e2d0c7cee078e059d66.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(

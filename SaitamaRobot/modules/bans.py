...
")
            ...
            message.reply_text(
                "Fighting this Asura Path here will put villager lives at risk.")
            return log_message
        elif user_id in DEMONS:
            message.reply_text(
                "Bring an order from Akatsuki Organization to fight a Human Path."
            )
            return log_message
        elif user_id in TIGERS:
            message.reply_text(
                "Bring an order from Akatsuki Organization to fight a Preta Path."
            )
            return log_message

...
def gban(update: Update, context: CallbackContext):
    ...
    if int(user_id) in DEV_USERS:
        message.reply_text(
            "That user is part of the Akatsuki\n I Am Not A Sinner!."
        )
        return
    ...
    if int(user_id) in DEMONS:
        message.reply_text(
            "OOOH someone's trying to gban a Human Path! *going to grab some popcorn packs*")
        return
    ...
    if user_id == bot.id:
        message.reply_text("But why? What did I do to you?")
        return
